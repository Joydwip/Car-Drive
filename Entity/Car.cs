...
namespace Entity
{
    public class Car
    {
        ...
        public void carRight(Graphics g)
        {
            ...
            g.FillEllipse(Brushes.Brown, 23, 35, 20, 20);
            //g.DrawEllipse(p, 23, 35, 20, 20);
            g.DrawLine(p, 42, 45, 90, 45);
            //g.DrawEllipse(p, 88, 35, 20, 20);

            g.FillEllipse(Brushes.Brown, 88, 35, 20, 20);
        ...
        public void carLeft(Graphics g)
        {
            ...
            g.FillEllipse(Brushes.Brown, 28, 35, 20, 20);

            g.FillEllipse(Brushes.Brown, 93, 35, 20, 20);
